...
- **Настройки.** Светлая/тёмная/системная тема, шесть валют, тактильный отклик,
  еженедельное локальное напоминание, архив целей и полный сброс.
- **Онбординг.** Три экрана с анимированными иллюстрациями и выбором валюты.
...
Новый пользователь видит чистый экран: целей нет, демо-данные не подставляются.
